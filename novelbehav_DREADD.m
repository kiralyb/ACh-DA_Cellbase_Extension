...
[Hitrate(1),HitrateF(1),FarateF(1)] = psychometric_7hzbehav_analysis('DHBAVD-04','230317d');
...
sigstar([2,3],signrank(HitrateF,HitrateF2))
...
sigstar([2,3],signrank(FarateF,FarateF2))
