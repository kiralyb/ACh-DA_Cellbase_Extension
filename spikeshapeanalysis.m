function [firing_rate,SpikeWidth,PeakIntegralToIntegral,PostValleyToPeak,PeakToPostValleyTime]=spikeshapeanalysis(cellids,issave)
...
% Balint   
PeakToPostValleyTime=SpikeShape{1}.PeakToPostValleyTime;
if isempty(PeakToPostValleyTime)
   PeakToPostValleyTime=NaN;
end

SpikeWidth=SpikeShape{1}.SpikeWidth;
if isempty(SpikeWidth)
   SpikeWidth=NaN;
end

PeakIntegralToIntegral=SpikeShape{1}.PeakIntegralToIntegral;
if isempty(PeakIntegralToIntegral)
   PeakIntegralToIntegral=NaN;
end

PostValleyToPeak=SpikeShape{1}.PostValleyToPeak;
if isempty(PostValleyToPeak)
   PostValleyToPeak=NaN;
end
...
% Waveform variables
sr = 30000;     % DigiLynx sampling rate
